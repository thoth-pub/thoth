...
static DATABASE_CONSTRAINT_ERRORS: Map<&'static str, &'static str> = phf_map! {
    ...
    "file_type_check" => "File type is invalid: frontcover must have work_id, publication must have publication_id.",
    "file_upload_type_check" => "File upload type is invalid: frontcover must have work_id, publication must have publication_id.",
