...
static DATABASE_CONSTRAINT_ERRORS: Map<&'static str, &'static str> = phf_map! {
    ...
    "abstract_content_check" => "Abstract content must not be an empty string.",
    "abstract_uniq_locale_idx" => "Abstract with this locale code and type of current work already exists.",
    "abstract_unique_canonical_true_idx" => "Canonical abstract of current work already exists.",
    "additional_resource_resource_ordinal_work_id_uniq" => "An additional resource with this ordinal number already exists.",
    "biography_content_check" => "Biography content must not be an empty string.",
    "biography_uniq_locale_idx" => "Biography with this locale code of current contribution already exists.",
    "biography_unique_canonical_true_idx" => "Canonical biography of current contribution already exists.",
    "award_award_ordinal_work_id_uniq" => "An award with this ordinal number already exists.",
    "book_review_review_ordinal_work_id_uniq" => "A book review with this ordinal number already exists.",
    ...
    "imprint_storage_cfg_all_or_none" => "Storage configuration must be complete: all fields (S3 bucket, region, CDN domain, CloudFront distribution ID) must be provided together, or all must be empty.",
    ...
    "subject_ordinal_type_uniq" => "A subject with this ordinal number and type already exists.",
    ...
    "title_unique_canonical_true_idx" => "Canonical title of current work already exists.",
    "title_full_title_check" => "Full title must not be an empty string.",
    "title_subtitle_check" => "Subtitle must not be an empty string.",
    "title_title_check" => "Title must not be an empty string.",
    "title_uniq_locale_idx" => "Title with this locale code of current work already exists.",
