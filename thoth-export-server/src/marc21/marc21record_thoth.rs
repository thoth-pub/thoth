...
impl Marc21Entry<Marc21RecordThoth> for Work {
    fn to_record(&self) -> ThothResult<Record> {
        ...
        let data_field = format!("{date}t{pub_year}{pub_year}        ob    000 0 {language} d");
        ...
        // 245 – title
        let mut title_field = FieldRepr::from((b"245", "00"));
