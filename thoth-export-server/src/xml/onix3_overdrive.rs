                    ...
                    for subject in &self.subjects {
                        ...
                        if subject.subject_type != SubjectType::THEMA {
                            write_element_block("Subject", w, |w| {
                                XmlElement::<Onix3Overdrive>::xml_element(
...
mod tests {
    ...
    fn test_onix3_overdrive_works() {
        ...
        assert_eq!(
            output,
            "Could not generate onix_3.0::overdrive: No ISBN supplied".to_string()
        );
        ...
        assert_eq!(
            output,
            "Could not generate onix_3.0::overdrive: No contributors supplied".to_string()
        );
    }
}
