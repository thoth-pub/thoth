...
use thoth_client::{
    ...
    PublicationType, SubjectType, Work, WorkContributions, WorkFundings, WorkIssues, WorkLanguages,
...
mod tests {
    ...
    use thoth_client::{
        ...
        WorkImprintPublisherContacts, WorkIssuesSeries, WorkPublicationsLocations, WorkStatus,
        WorkType,
    };
    use uuid::Uuid;
