                ...
                _ => {
                    for work in works.iter() {
                        ...
                        if work.work_type != WorkType::BOOK_CHAPTER {
                            XmlElementBlock::<Onix21ProquestEbrary>::xml_element(work, w).ok();
                        }
                    }
                    Ok(())
                }
    ...
    fn xml_element<W: Write>(&self, w: &mut EventWriter<W>) -> ThothResult<()> {
        ...
        write_element_block("Product", w, |w| {
            ...
            for issue in &self.issues {
                XmlElementBlock::<Onix21ProquestEbrary>::xml_element(issue, w).ok();
            }
            ...
            for subject in &self.subjects {
                XmlElementBlock::<Onix21ProquestEbrary>::xml_element(subject, w).ok();
            }
            ...
            XmlElement::<Onix21ProquestEbrary>::xml_element(&self.work_status, w)?;
...
impl XmlElement<Onix21ProquestEbrary> for WorkStatus {
...
impl XmlElement<Onix21ProquestEbrary> for SubjectType {
...
impl XmlElement<Onix21ProquestEbrary> for LanguageRelation {
...
impl XmlElement<Onix21ProquestEbrary> for ContributionType {
...
impl XmlElementBlock<Onix21ProquestEbrary> for WorkContributions {
    fn xml_element<W: Write>(&self, w: &mut EventWriter<W>) -> ThothResult<()> {
        write_element_block("Contributor", w, |w| {
            ...
            XmlElement::<Onix21ProquestEbrary>::xml_element(&self.contribution_type, w)?;
...
impl XmlElementBlock<Onix21ProquestEbrary> for WorkLanguages {
    fn xml_element<W: Write>(&self, w: &mut EventWriter<W>) -> ThothResult<()> {
        write_element_block("Language", w, |w| {
            XmlElement::<Onix21ProquestEbrary>::xml_element(&self.language_relation, w).ok();
...
impl XmlElementBlock<Onix21ProquestEbrary> for WorkIssues {
    fn xml_element<W: Write>(&self, w: &mut EventWriter<W>) -> ThothResult<()> {
...
impl XmlElementBlock<Onix21ProquestEbrary> for WorkSubjects {
    fn xml_element<W: Write>(&self, w: &mut EventWriter<W>) -> ThothResult<()> {
        write_element_block("Subject", w, |w| {
            XmlElement::<Onix21ProquestEbrary>::xml_element(&self.subject_type, w)?;
...
mod tests {
    ...
    fn generate_test_output(
        expect_ok: bool,
        input: &impl XmlElementBlock<Onix21ProquestEbrary>,
    ) -> String {
    ...
    #[test]
    fn test_onix21_proquest_ebrary_contributions() {
    ...
    #[test]
    fn test_onix21_proquest_ebrary_languages() {
    ...
    #[test]
    fn test_onix21_proquest_ebrary_subjects() {
    ...
    #[test]
    fn test_onix21_proquest_ebrary_works() {
