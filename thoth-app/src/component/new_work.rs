            ...
            Msg::CreateWork => {
                let body = CreateWorkRequestBody {
                    variables: Variables {
                        ...
                        edition: self.work.edition.clone(),
                        doi: self.work.doi.clone(),
                        publication_date: self.work.publication_date.clone(),
                        place: self.work.place.clone(),
                        width: self.work.width.clone(),
                        height: self.work.height.clone(),
                        page_count: self.work.page_count.clone(),
                        page_breakdown: self.work.page_breakdown.clone(),
                        image_count: self.work.image_count.clone(),
