...
#[cfg_attr(
    ...
    graphql(description = "Set of values required to define a new grant awarded to the publication of a work by an institution"),
...
#[cfg_attr(
    ...
    graphql(description = "Set of values required to update an existing grant awarded to the publication of a work by an institution"),
