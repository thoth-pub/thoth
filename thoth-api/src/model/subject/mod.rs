...
static THEMA_CODES: Map<&'static str, &'static str> = phf_map! {
    ...
    "JBCC3" => "Cultural studies: fashion and society",
    ...
    "KFCM" => "Management accounting and bookkeeping",
    ...
    "KJMV22" => "Diversity and inclusion in the workplace",
    "KJMV4" => "Management of real estate, property and plant",
    ...
    "MRG" => "Medical study and revision guides",
    ...
    "QRDF" => "Hindu sacred texts and revered writings",
    ...
    "QRFB23" => "Zen Buddhism",
    "QRFF" => "Buddhist sacred texts and revered writings",
    ...
    "QRPF" => "Islamic sacred texts and revered writings",
    ...
    "TVR" => "Forestry and silviculture: practice and techniques",
    ...
    "VFJ" => "Coping with personal, social and health topics",
    "VFJB" => "Coping with illness and specific health conditions",
    ...
    "VXQM" => "Mythical and legendary beings, monsters and creatures",
    ...
    "XAK" => "American / British style comic books and graphic novels",
    "XAKC" => "American comic books: classic, Golden Age",
    "XAM" => "Manga and Asian style comics",
    "XAMC" => "Manga: Kodomo",
    "XAMF" => "Manga: Shōjo",
    "XAMG" => "Manga: Shōnen",
    "XAML" => "Manga: Seinen",
    ...
    "XAMY" => "Manga: Yuri",
    "XQ" => "Graphic novel, Comic book and Manga: genres",
    ...
    "XR" => "Graphic novel and comic books: guides and reviews",
    ...
    "YBCS1" => "Picture storybooks: bedtime stories and dreams",
    ...
    "YND" => "Children’s / Teenage general interest: Drama and performing",
    ...
    "YNK" => "Children’s / Teenage general interest: Work and society",
    ...
    "YNNJ24" => "Children’s / Teenage general interest: Ponies and horses",
    ...
    "YNNV" => "Children’s / Teenage general interest: Rocks, weather and physical world",
    ...
    "YNTP" => "Children’s / Teenage general interest: Buildings and construction",
    ...
    "YNXB6" => "Children’s / Teenage general interest: Mermaids / Merfolk",
    ...
    "YPZN" => "Educational: Non-Verbal reasoning",
    ...
    "YXE" => "Children’s / Teenage personal and social topics: Emotions, moods and feelings",
    ...
    "YXG" => "Children’s / Teenage personal and social topics: Death and bereavement",
    ...
    "YXLD1" => "Children’s / Teenage personal and social topics: Eating disorders",
    ...
    "YXT" => "Children’s / Teenage personal and social topics: Truancy and school problems",
    ...
    "YXZM" => "Children’s / Teenage social issues: Migration and refugees",
    ...
    "1DFA-AT-KD" => "Villach",
    "1DFA-AT-KF" => "Wörthersee (Lake Wort)",
    "1DFA-AT-M" => "Styria",
    ...
    "1QB" => "Historical states, empires and regions",
    "1QBA" => "Ancient World",
    ...
    "1QBAS" => "Sumer",
    "1QBAT" => "Etruria",
    "1QBC" => "Historical states and empires: multi-continental",
    ...
    "1QBD" => "Historical states and empires: Europe",
    ...
    "1QBF" => "Historical states and empires: Asia",
    "1QBH" => "Historical states and empires: Africa",
    ...
    "1QBM" => "Historical states and empires: Australasia, Oceania and other land areas",
    ...
    "2HCBN" => "Duala",
    "2HCBP" => "Tshivenda and Venda group",
    "2HCBQ" => "Shona",
    ...
    "3MNB-US-D" => "c 1800 to c 1861 (period of American exploration and expansion)",
    ...
    "4CN" => "For advanced secondary education",
    ...
    "4TYB" => "For home learning: beginner levels",
    ...
    "4Z-BE-BEBA" => "General Secondary Education (ASO)",
    "4Z-BE-BEBB" => "Vocational Secondary Education (BSO)",
    "4Z-BE-BEBC" => "Art Secondary Education (KSO)",
    "4Z-BE-BEBD" => "Technical Secondary Education (TSO)",
    "4Z-BE-BEC" => "Third cycle (years 5 and 6)",
    "4Z-BE-BECA" => "General Secondary Education (ASO)",
    "4Z-BE-BECB" => "Vocational Secondary Education (BSO)",
    "4Z-BE-BECC" => "Art Secondary Education (KSO)",
    "4Z-BE-BECD" => "Technical Secondary Education (TSO)",
    ...
    "5JA" => "Intended primarily or specifically for women and/or girls",
    "5JB" => "Intended primarily or specifically for men and/or boys",
    ...
    "5PB" => "Relating to peoples: ethnic groups, indigenous peoples, cultures, tribes and other groupings of people",
    ...
    "5PSB" => "Relating to bisexuals or pansexuals",
