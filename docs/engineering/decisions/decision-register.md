...
activate. It is delivered by
[`CTRL-MERGE-01`](../ai-delivery/tasks/CTRL-MERGE-01.md) under
[issue #786](https://github.com/thoth-pub/thoth/issues/786), and it is not
authoritative until that pull request is independently reviewed at its exact
head, explicitly CTO merge-authorized and merged into `develop`. It applies to
tasks starting after that merge; historical records are preserved as written and
are not rewritten to conform.
