...
| CTRL-BRANCH-RELEASE-01 Preserve established release branch names | `thoth` | MEDIUM | IN IMPLEMENTATION | `develop` at `4546cb632428872b961ad6c17282984d298e3ade` -> `develop` | Delivers `ADR-0011`. Documentation/control only. Repository-authoritative only after independent exact-head review, separate merge authorization and merge into `develop`; GitHub is authoritative for its live pull-request, CI and merge state | [#897](https://github.com/thoth-pub/thoth/issues/897) |
