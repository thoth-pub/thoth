...
Metrics-specific entitlement table is created; the exact authorized base of
this slice is `feature/metrics @ 27e0811ada32b38ef43458c47db5c3c94e4b4680`, and
reconciling the dedicated `MET-WP1-10` tracker record is outside this slice's
authorized write scope; the `MET-WP1-09` OPERAS export ledger persistence
foundation (issue [#884](https://github.com/thoth-pub/thoth/issues/884)) is
merged into
