...
provenance-classification enums — is merged/delivered to `feature/metrics`
through PR [#873](https://github.com/thoth-pub/thoth/pull/873); the completed
...
|---|---|---|---:|---|---|---|
| WP1 | Domain and database foundation | `thoth` | HIGH | IN PROGRESS | entry gates satisfied; registry foundation (`MET-WP1-01`), source-state foundation (`MET-WP1-02`), import-state foundation (`MET-WP1-03`) and record-history foundation (`MET-WP1-04`) merged/delivered to `feature/metrics`; each remaining slice requires its own approved bounded specification and separate authorization | #766 |
