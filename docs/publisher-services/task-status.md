...
14. BE-04's BE-02, BE-03 and `ADR-0008` dependencies are **satisfied**, and the
    ...
    **approved baseline** and is repository-authoritative. The CTO then
    ...
    separate, **not yet approved** amendment candidate, and the baseline
    authorization is insufficient for implementation against it: that requires
    addendum approval, the approved content reaching `develop`, a freshly
    ...
    draft, unmerged implementation pull request now exist; that is observed
